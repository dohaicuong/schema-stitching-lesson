...
export type QueryResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  forecasts?: Resolver<Maybe<Array<ResolversTypes['Weather']>>, ParentType, ContextType, RequireFields<QueryForecastsArgs, never>>;
};
...
export type WeatherResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Weather'] = ResolversParentTypes['Weather']> = {
  ...
  status?: Resolver<Maybe<ResolversTypes['WeatherStatus']>, ParentType, ContextType>;
